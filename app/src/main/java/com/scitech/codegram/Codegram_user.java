...
public class Codegram_user {
    ...
    public Codegram_user()
    {

    }

    public Codegram_user(String email, String username, String picUrl)
    {
        this.email = email;
    ...
    public Codegram_user(String id, String email, String username, String mobile, String status,
